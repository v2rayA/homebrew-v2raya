$Latest_Commit_ID = (((Invoke-RestMethod -Uri "https://api.github.com/repos/v2rayA/v2rayA/commits/main").commit).url).Split('/')[8]
...
$Latest_Version_Date = ((((((Invoke-RestMethod -Uri "https://api.github.com/repos/v2rayA/v2rayA/commits/main").commit).author) | ConvertTo-Json).Split('"')[11]).Split('T')[0]) -replace '-',''
